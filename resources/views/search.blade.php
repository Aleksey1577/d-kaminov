...
@section('seo_title', 'Поиск по каталогу каминов и печей | Дом каминов')
@section('seo_description', request('search')
    ? 'Результаты поиска по запросу "' . e(request('search')) . '" в каталоге Дом каминов: камины, топки, печи, аксессуары.'
